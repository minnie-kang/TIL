...
erDiagram
    ...
    Course ||--o{ UserCourse : contains
    Course ||--o{ Lesson : has
    Lesson ||--o{ Quiz : contains
    Lesson ||--o{ PracticeExercise : contains
    User ||--o{ Post : writes
    User ||--o{ AI_Interaction : has
    LearningRoadmap ||--o{ RoadmapStep : contains
    User ||--o{ UserRoadmapProgress : tracks
    RoadmapStep ||--o{ UserRoadmapProgress : includes
    User ||--o{ UserPerformance : achieves
    Performance ||--o{ UserPerformance : measures
    '''